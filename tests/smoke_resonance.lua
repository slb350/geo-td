...
function M.run(check, near)
  ...
  local a = tower.place(r, 215, 150, "pellet")
  modifier.socket_module(r, a, "triangle")
  local b = tower.place(r, 200, 165, "pellet")
  modifier.socket_module(r, b, "hex")
  resonance.update(r)
  ...
  local t1 = tower.place(rc, 200, 150, "pellet")
  modifier.socket_module(rc, t1, "triangle")
  local t2 = tower.place(rc, 215, 150, "pellet")
  modifier.socket_module(rc, t2, "triangle")
  local t3 = tower.place(rc, 200, 165, "pellet")
  modifier.socket_module(rc, t3, "triangle")
  resonance.update(rc)
  ...
  tower.place(rf, 215, 150, "pellet")
  modifier.socket_module(rf, rf.towers[2], "triangle")
  tower.place(rf, 200, 165, "pellet")
  modifier.socket_module(rf, rf.towers[3], "hex")
  rf.enemies.n = 0
  ...
  tower.place(rg, 215, 150, "pellet")
  modifier.socket_module(rg, rg.towers[2], "triangle")
  tower.place(rg, 200, 165, "pellet")
  modifier.socket_module(rg, rg.towers[3], "circle")
  resonance.update(rg)
  ...
  check(
    near(ge.damage, tower.DEFS.flak.damage * 2 * 1.5),
  ...
  do
    ...
    tower.place(ro, 215, 150, "pellet")
    modifier.socket_module(ro, ro.towers[2], "circle")
    tower.place(ro, 200, 165, "pellet")
    modifier.socket_module(ro, ro.towers[3], "hex")
    resonance.update(ro)
  ...
  do
    ...
    tower.place(rw, 215, 150, "pellet")
    modifier.socket_module(rw, rw.towers[2], "diamond")
    tower.place(rw, 200, 165, "pellet")
    modifier.socket_module(rw, rw.towers[3], "square")
    resonance.update(rw)
    ...
    for _ = 1, 90 do
      proj.update(rw, 1 / 60)
      if rw.rings.n > 0 then break end
    end
  ...
  do
    ...
    local e1 = enemy.spawn(rgv, "hulk", 1, 1, 10)
    e1.x, e1.y = 100, 100
    local e2 = enemy.spawn(rgv, "hulk", 1, 1, 10)
    e2.x, e2.y = 120, 100
    ...
    tower.place(rgf, 215, 150, "pellet")
    modifier.socket_module(rgf, rgf.towers[2], "triangle")
    tower.place(rgf, 200, 165, "pellet")
    modifier.socket_module(rgf, rgf.towers[3], "circle")
    resonance.update(rgf)
    rgf.enemies.n = 0
    rgf.projectiles.n = 0
    local fly = enemy.spawn(rgf, "wisp", 1, 1, 10)
    fly.x, fly.y = 206, 150
    flak2.cooldown = 0
    tower.update(rgf, 1 / 60)
    for _ = 1, 90 do
      proj.update(rgf, 1 / 60)
      if (fly.mark_t or 0) > 0 then break end
    end
  ...
  tower.place(rd, 215, 150, "pellet")
  resonance.update(rd)
  check(
    rd.towers[1].resonance == nil and rd.towers[2].resonance == nil,
