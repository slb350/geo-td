...
for i = 1, #P.SEMANTIC do
  NORMAL[P.SEMANTIC[i]] = P[P.SEMANTIC[i]]
end

local HIGH = {
  BG = gfx.COLOR_BLACK,
  FIELD_BG = gfx.COLOR_BLACK,
  PATH = gfx.COLOR_LIGHT_GRAY,
  PATH_EDGE = gfx.COLOR_WHITE,
  PATH_CORE = gfx.COLOR_WHITE,
  PULSE = gfx.COLOR_YELLOW,
  CORE = gfx.COLOR_GREEN,
  SPAWN = gfx.COLOR_RED,
  TEXT = gfx.COLOR_WHITE,
  TEXT_DIM = gfx.COLOR_LIGHT_GRAY,
  RANGE = gfx.COLOR_WHITE,
  HUD_PANEL = gfx.COLOR_DARK_GRAY,
}
