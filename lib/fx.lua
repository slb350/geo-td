...
local function play_ex(name, vol, pitch)
  sfx.play_ex(name, vol or 1, pitch or 1, 0)
end
...
function fx.life_lost()
  effect.flash(0.16, gfx.COLOR_RED)
  fx.shake(0.22, 4)
  play("life")
end
function fx.boss_hit()
  fx.shake(0.14, 2.5)
end
function fx.boss_death()
  effect.hitstop(0.18)
  fx.shake(0.5, 6)
  effect.flash(0.22, gfx.COLOR_WHITE)
  play("boss_die")
end
...
function fx.hit_sfx()
  play_ex("hit", 0.4, 0.9 + math.random() * 0.4)
end
function fx.kill_sfx()
  play("kill")
end
function fx.place_sfx()
  play("place")
end
function fx.sell_sfx()
  play("sell")
end
function fx.wave_sfx()
  play("wave")
end
function fx.boss_sfx()
  play("boss")
end
function fx.upgrade_sfx()
  play("upgrade")
end
function fx.click_sfx()
  play("click")
end
function fx.over_sfx()
  play("over")
end
